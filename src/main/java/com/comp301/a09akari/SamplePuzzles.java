...
public class SamplePuzzles {
  ...
  public static List<Puzzle> create() {
    if (puzzles == null) {
      ...
      puzzles.add(new PuzzleImpl(PUZZLE_01));
      puzzles.add(new PuzzleImpl(PUZZLE_02));
      puzzles.add(new PuzzleImpl(PUZZLE_03));
      puzzles.add(new PuzzleImpl(PUZZLE_04));
      puzzles.add(new PuzzleImpl(PUZZLE_05));
    }
    return puzzles;
  }
}
